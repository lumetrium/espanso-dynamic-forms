...
The `i18n` top-level key of the [form config](./index) enables internationalization (i18n) 
support for form labels, descriptions, validation errors, and other UI text elements.

> [!note] Optional Section
> If omitted, all text elements will use default English strings.
