...
[IMAGE: Same form displayed twice side by side: left shows English labels "Please upload a file" and "Remove", right shows Russian labels "Пожалуйста, загрузите файл" and "Удалить", demonstrating how the same form adapts to different locales]
...
Both singleFile and multipleFiles properties reference the same file translation key, sharing translations while the renderers automatically adapt labels based on whether the field is singular or plural.
